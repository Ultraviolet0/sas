...
<form action="<?php echo url_for('salamanders/edit.php?id=' . h(u($id))); ?>" method="post">
  ...
  <input type="text" id="salamander_name" name="salamander_name" value="<?php echo h($salamander['name']); ?>" required><br>

  <label for="habitat">Habitat:</label><br>
  <textarea id="habitat" name="habitat" cols="50" rows="5" required><?php echo h($salamander['habitat']); ?></textarea><br>

  <label for="description">Description:</label><br>
  <textarea id="description" name="description" cols="50" rows="5" required><?php echo h($salamander['description']); ?></textarea><br>
